...
if __name__ == "__main__":
    model = SimpleClassifier(2, 4, 1).cuda()
    # print(model)
    ...
    # print(f"Data inputs {data_labels.shape}\n {data_labels}")
    ...
    train_model_with_logger(model, optimizer, dataloader, loss_module, val_dataset=dataset)
